...
from networks import CriticDQNsImit
from agents.agent import Agent
from buffers import ReplayBuffer, PrioritizedReplayBuffer

class DQNsImit(Agent):

    def __init__(self, args, env, env_test, logger):
        super(DQNsImit, self).__init__(args, env, env_test, logger)
        self.per = args['--per'] != '0'
    ...
    def init(self, env):
        ...
        self.critic = CriticDQNsImit(s_dim=env.state_dim,
